...
Though this might not be a very helpful application, image classifiers play a key role in e.g. systems for autonomous driving, by classifying objects on the road, identifying if someone are distracted etc.  For overview of an application of computer vision in self-driving cars, see this [presentation by Drago Anguelov of Waymo](https://youtu.be/Q0nGo2-y0xY). Other use cases of image classification includes assessing [the health of coral reefs](https://www.computerweekly.com/news/252496333/How-computer-vision-can-protect-coral-reefs) or [medical image analysis and more](https://www.altexsoft.com/blog/image-recognition-neural-networks-use-cases/).
